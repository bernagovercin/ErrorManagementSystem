...
using Core.Services;
using Microsoft.AspNetCore.Hosting; // FileService'i kullanmak için
...
namespace Tests.Business.HandlersTest
{
    ...
    public class CustomerHandlerTests
    {
        ...
        Mock<FileService> _fileService; // FileService mock'u eklendi
        ...
        public void Setup()
        {
            ...
            _fileService = new Mock<FileService>(MockBehavior.Strict, new Mock<IWebHostEnvironment>().Object); // FileService mock'u oluşturuldu
        }
        ...
        public async Task Customer_CreateCommand_Success()
        {
            ...
            // FileService mock'u için setup
            _fileService.Setup(x => x.SaveFileAsync(It.IsAny<Microsoft.AspNetCore.Http.IFormFile>())).ReturnsAsync("uploads/test.jpg");

           // var handler = new CreateCustomerCommandHandler(_customerRepository.Object, _mediator.Object, _fileService.Object); // FileService mock'u eklendi
        ...
        public async Task Customer_UpdateCommand_Success()
        {
          ...
          //  var handler = new UpdateCustomerCommandHandler(_customerRepository.Object, _mediator.Object, _fileService.Object); // FileService mock'u eklendi
          //  var x = await handler.Handle(command, new System.Threading.CancellationToken());
